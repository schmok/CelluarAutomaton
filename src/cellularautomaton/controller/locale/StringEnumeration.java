...
public enum StringEnumeration {
    ...
    MI_SETTINGS_SAVE("MI_SETTINGS_SAVE"),
    MI_SETTINGS_LOAD("MI_SETTINGS_LOAD"),
    MI_SETTINGS_DELETE("MI_SETTINGS_DELETE"),
    MI_OK("MI_OK"),
    MI_ABBORT("MI_ABBORT"),
    ...
    W_SETTINGS_DUB_ENTRY("W_SETTINGS_DUB_ENTRY"),
    W_SETTINGS_SAVE("W_SETTINGS_SAVE"),
    W_SETTINGS_LOAD("W_SETTINGS_LOAD"),
    W_SETTINGS_DELETE("W_SETTINGS_DELETE"),
    W_SETTINGS_NAME("W_SETTINGS_NAME"),
    W_SETTINGS_SAVED("W_SETTINGS_SAVED"),
    // States ect.
    SI_STATE(""),
    SI_COLOR(""),
